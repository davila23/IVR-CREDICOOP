...
public class StepValidateDate extends Step {
	...
	public StepValidateDate(UUID tmpid) {
		this.id = tmpid;
	...
	private boolean esFechaValida(String day, String month, String year) {
		...
		try {
			...
			Logger.getLogger(StepValidateDate.class.getName()).log(Level.WARN,
					null, e);
		}

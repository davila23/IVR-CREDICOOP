...
public class PideDniCredicoop implements StepGroup {
	...
	private StepPlayRead stepAudioDni;
	private StepPlayRead stepAudioValidate;
	private StepPlay stepAudioSuDniEs;
	private StepPlay stepAudioDniInvalido;
	private StepSayDigits stepDiceDni;
	private StepCounter contadorIntentosDni;
	private StepConditional evalContadorDni;

	private StepMenu stepMenuConfirmacionMenu;
	private StepValidateDni validaDni;

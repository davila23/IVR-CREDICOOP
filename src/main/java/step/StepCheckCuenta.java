...
public class StepCheckCuenta extends Step {
	...
	public StepCheckCuenta(UUID tmpid) {
		this.id = tmpid;
	...
	public boolean execute(Context context) throws Exception {
		...
		String cuenta = cuentaContextVar.getVarValue().toString();

		if (cuentas_aux.contains(cuenta)) {
